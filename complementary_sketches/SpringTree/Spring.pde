...
class Spring {
  ...
  Spring(Node theFromNode, Node theToNode, int fromNodeID, int toNodeID) {
    fromNode = theFromNode;
    toNode = theToNode;
    fromNodeID = this.fromNodeID;
    toNodeID = this.fromNodeID;
  ...
  void update() {
   ...
   void drawMe(){
    noiseFx += step;
     ...
     c1XNoise = map(noise(noiseFx,10,20),0,1,-150,150);
     c1YNoise = map(noise(noiseFy,2,87),0,1,-150,150);
     c2XNoise = map(noise(noiseFx,5,12),0,1,-150,150);
     c2YNoise = map(noise(noiseFy,15,30),0,1,-150,150);
